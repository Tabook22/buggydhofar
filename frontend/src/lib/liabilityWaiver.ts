const ORGANIZER_NAME_EN = "Buggy Dhofar";
const ORGANIZER_NAME_AR = "باجي ظفار";
...
export function buildLiabilityWaiverText(fields: WaiverFields, language: string): string {
  ...
  if (language.startsWith("ar")) {
    return `إقرار وورقة إخلاء مسؤولية
...
أقرّ بأنني أرغب بالمشاركة في تجربة ركوب دراجات الدفع الرباعي (باجي) التي تنظمها ${ORGANIZER_NAME_AR}، وتاريخ الرحلة المحدد ${rideDate}، وأعلم أن هذه الرياضة قد تنطوي على بعض المخاطر الناتجة عن:
...
التاريخ: ${today}`;
  ...
  return `Declaration and Liability Waiver
...
I acknowledge that I wish to participate in the quad-bike (buggy) experience organized by ${ORGANIZER_NAME_EN} on ${rideDate}, and I understand that this activity may involve risks arising from:
