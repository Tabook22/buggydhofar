...
class SiteContent(Base):
    ...
    availability_live_en: Mapped[str] = mapped_column(String(120), default="Live availability")
    availability_live_ar: Mapped[str] = mapped_column(String(120), default="توفر مباشر")
    availability_title_en: Mapped[str] = mapped_column(String(180), default="Buggy Bikes Board")
    availability_title_ar: Mapped[str] = mapped_column(String(180), default="لوحة الباجيات")
    availability_subtitle_en: Mapped[str] = mapped_column(Text, default="Real-time fleet status by time slot — like an airport departures screen.")
    availability_subtitle_ar: Mapped[str] = mapped_column(Text, default="حالة الأسطول حسب الوقت — مثل شاشة المطارات.")
    site_name_en: Mapped[str] = mapped_column(String(180), default="Buggy Bike Booking")
    site_name_ar: Mapped[str] = mapped_column(String(180), default="حجز الباجي")
    footer_text_en: Mapped[str] = mapped_column(Text, default="Simple buggy bike booking for guests in Salalah.")
    footer_text_ar: Mapped[str] = mapped_column(Text, default="حجز بسيط للباجي للضيوف في صلالة.")
    nav_book_en: Mapped[str] = mapped_column(String(80), default="Book Now")
    nav_book_ar: Mapped[str] = mapped_column(String(80), default="احجز الآن")
    footer_admin_en: Mapped[str] = mapped_column(String(80), default="Admin")
    footer_admin_ar: Mapped[str] = mapped_column(String(80), default="الإدارة")
    how_title_en: Mapped[str] = mapped_column(String(180), default="Simple Booking Steps")
    how_title_ar: Mapped[str] = mapped_column(String(180), default="خطوات الحجز البسيطة")
    how_step1_title_en: Mapped[str] = mapped_column(String(120), default="Choose Date")
    how_step1_title_ar: Mapped[str] = mapped_column(String(120), default="اختر التاريخ")
    how_step1_text_en: Mapped[str] = mapped_column(Text, default="Pick your preferred date.")
    how_step1_text_ar: Mapped[str] = mapped_column(Text, default="حدد التاريخ المناسب لك.")
    how_step2_title_en: Mapped[str] = mapped_column(String(120), default="Pick Time Slot")
    how_step2_title_ar: Mapped[str] = mapped_column(String(120), default="اختر الوقت")
    how_step2_text_en: Mapped[str] = mapped_column(Text, default="See how many buggies are free for each time.")
    how_step2_text_ar: Mapped[str] = mapped_column(Text, default="شاهد عدد الباجيات المتاحة لكل وقت.")
    how_step3_title_en: Mapped[str] = mapped_column(String(120), default="Select Buggy")
    how_step3_title_ar: Mapped[str] = mapped_column(String(120), default="اختر الباجي")
    how_step3_text_en: Mapped[str] = mapped_column(Text, default="Choose an available buggy bike from the fleet.")
    how_step3_text_ar: Mapped[str] = mapped_column(Text, default="اختر دراجة باجي متاحة من الأسطول.")
    how_step4_title_en: Mapped[str] = mapped_column(String(120), default="Pay")
    how_step4_title_ar: Mapped[str] = mapped_column(String(120), default="ادفع")
    how_step4_text_en: Mapped[str] = mapped_column(Text, default="Pay by Visa or bank transfer.")
    how_step4_text_ar: Mapped[str] = mapped_column(Text, default="ادفع بالفيزا أو التحويل البنكي.")
    ...
    faq_title_en: Mapped[str] = mapped_column(String(180), default="Frequently Asked Questions")
    faq_title_ar: Mapped[str] = mapped_column(String(180), default="الأسئلة الشائعة")
