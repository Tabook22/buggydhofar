...
HOME_CONTENT = {
    ...
    "how_title_en": "Simple Booking Steps",
    "how_title_ar": "خطوات الحجز البسيطة",
    "how_step1_title_en": "Choose Date",
    "how_step1_title_ar": "اختر التاريخ",
    "how_step1_text_en": "Pick your preferred date.",
    "how_step1_text_ar": "حدد التاريخ المناسب لك.",
    "how_step2_title_en": "Pick Time Slot",
    "how_step2_title_ar": "اختر الوقت",
    "how_step2_text_en": "See how many buggies are free for each time.",
    "how_step2_text_ar": "شاهد عدد الباجيات المتاحة لكل وقت.",
    "how_step3_title_en": "Select Buggy",
    "how_step3_title_ar": "اختر الباجي",
    "how_step3_text_en": "Choose an available buggy bike from the fleet.",
    "how_step3_text_ar": "اختر دراجة باجي متاحة من الأسطول.",
    "how_step4_title_en": "Pay",
